...
public class Test1 implements TalendJob {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_GITTEST_Test1 = new byte[0];
		static byte[] commonByteArray_GITTEST_Test1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GITTEST_Test1.length) {
					if (length < 1024 && commonByteArray_GITTEST_Test1.length == 0) {
						commonByteArray_GITTEST_Test1 = new byte[1024];
					} else {
						commonByteArray_GITTEST_Test1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GITTEST_Test1, 0, length);
				strReturn = new String(commonByteArray_GITTEST_Test1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GITTEST_Test1) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Test1.class.getClassLoader()
					.getResourceAsStream("gittest/test1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 35307 characters generated by Talend Open Studio for Big Data on the
 * 2021/07/16 17:39:41 JST
 ************************************************************************************************/